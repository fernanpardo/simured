/*
 * Red.java
 * Network model. This class is the top of the complete network model
 */
...
// Statistics counters
  public int LatLast;           // Latencia del �ltimo paquete
  ...
  // Nuevos
  public Random random = new Random(); // si nada, semilla aleatoria, sino aqu� pondria la semilla si quiero siempre el mismo resultado
