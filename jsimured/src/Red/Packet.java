 ...
 * Packet.java
 *
 * Created on 27 de septiembre de 2004, 22:55
 * Modified may 2012
 */
/**
 *
...
public class Packet {
  ...
  public Packet(Red unared, int longit, int orig, int dest, int packid) {
    ...
    LaRed.Nodes[Src].ElProcIn.putPacket(this); // cuidado pues el paquete se está construyendo y ya se está usando, debería llamarse fuera...
